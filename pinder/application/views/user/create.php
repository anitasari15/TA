    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <form action="<?php echo base_url(); ?>index.php/dashboard/login/process_create" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="user_fullname" placeholder="" class="form-control form-control-line" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Title</label>
                                        <div class="col-md-12">
                                            <input type="text" name="user_title" placeholder="" class="form-control form-control-line" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" name="user_email" placeholder="" class="form-control form-control-line" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="password" name="user_password" placeholder="" class="form-control form-control-line" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="user_role" class="form-control form-control-line">
                                                <option value="1">Pelatih Sekolah</option>
                                                <option value="2">Pelatih Kota</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
