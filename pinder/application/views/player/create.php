        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>index.php/dashboard/player/process_create" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    ...
                                    <div class="card-block">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBodyBalance">
                                                Panduan
                                                </button>

                                                <input type="number" name="body_balance" min="1" max="31" step="1" class="form-control form-control-line" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalLeap">
                                                Panduan
                                                </button>

                                                <input type="number" name="leap" min="1" max="170" step="1" class="form-control form-control-line" required="required"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRunningspeed">
                                                Panduan
                                                </button>
                                                <input type="number" name="running_speed" min="1" max="160" step="1" class="form-control form-control-line" required="required"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="number" name="agility" min="1" max="36" step="1" class="form-control form-control-line" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalStamina">
                                                Panduan
                                                </button>

                                                <input type="number" name="stamina" min="1" max="3390" step="1" class="form-control form-control-line" required="required"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDribble">
                                                Panduan
                                                </button>



                                                <input type="number" name="dribble" min="1" max="17" step="1" class="form-control form-control-line" required="required" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalShooting">
                                                Panduan
                                                </button>

                                                <input type="number" name="shooting_accuracy" min="1" max="27" step="1" class="form-control form-control-line" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <!-- Button trigger modal -->
                                                <button style="float: right;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPassing">
                                                Panduan
                                                </button>

                                                <input type="number" name="passing_accuracy" min="1" max="50" step="1" class="form-control form-control-line" required="required">
